...
public class SingletonExample {
    ...
    private static final PerformanceImpactingSomething SOMETHING = new PerformanceImpactingSomething();
    ...
    private static final class PerformanceImpactingSomething {
        ...
        private String doSomething() {
            try {
                Thread.sleep(5000L);
            } catch (InterruptedException ex) { // InterruptedException 예외 처리를 추가합니다.
                Thread.currentThread().interrupt(); // 예외 발생 시 인터럽트 상태를 다시 설정합니다.
            }
            return "Hello, World!";
        }
    }
